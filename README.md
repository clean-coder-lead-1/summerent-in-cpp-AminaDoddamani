...
- Enter Reflections: Replace the enter word in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**1.We do follow coverity and warning checks in our daily work , but no cyclometric complexity .this is something nice to be follwed **
**2.Even we have lot of Switch and if/elseif statements been used. Some nice ideas on how to refactor such code **
**3.How to follow Standard coding guidelines over the projct deadlines:) **
